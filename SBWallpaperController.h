...
@class NSHashTable, NSMutableSet, NSString, SBFWallpaperView, SBWallpaperAggdLogger, SBWallpaperControllerCoordinator, SBWallpaperEffectView, SBWallpaperPreviewSnapshotCache, UIView, UIWindow;
