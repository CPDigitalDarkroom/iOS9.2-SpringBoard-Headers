...
@class NSCountedSet, NSMutableArray, NSMutableSet, NSSet, NSString, SBAppStatusBarSettingsAssertion, SBChevronView, SBDisableAppStatusBarAlphaChangesAssertion, SBFLockScreenDateView, SBFakeStatusBarView, SBIrisWallpaperSettings, SBLockOverlayStylePropertiesFactory, SBLockScreenBatteryChargingView, SBLockScreenBounceAnimator, SBLockScreenScrollView, SBLockScreenTimerView, SBSlideToUnlockFailureRecognizer, SBSlideUpAppGrabberView<SBLegibility><_SBFVibrantView>, SBSlideUpAppGrabberView<_SBFVibrantView>, SBWallpaperEffectView, UIColor, UIGestureRecognizer, UIScrollView, UIView, UIView<SBLegibility>, UIView<SBUIPasscodeLockView>, _UIBackdropView, _UIGlintyStringView<_SBFVibrantView>, _UILegibilitySettings;
...
@property(readonly, retain, nonatomic) UIView *foregroundView; // @synthesize foregroundView=_foregroundView;
@property(readonly, retain, nonatomic) UIScrollView *scrollView; // @synthesize scrollView=_foregroundScrollView;
