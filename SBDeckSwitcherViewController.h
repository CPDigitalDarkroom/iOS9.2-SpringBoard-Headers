...
- (struct CGRect)_frameForIndex:(unsigned long long)arg1 displayItemsCount:(unsigned long long)arg2 transitionParameters:(CDStruct_efa48ab2)arg3 scrollProgress:(double)arg4 ignoringScrollOffsetAndKillingAdjustments:(_Bool)arg5 ignoringPinning:(_Bool)arg6;
- (double)_leadingOffsetForIndex:(unsigned long long)arg1 displayItemsCount:(unsigned long long)arg2 transitionParameters:(CDStruct_efa48ab2)arg3 scrollProgress:(double)arg4 ignoringScrollOffsetAndKillingAdjustments:(_Bool)arg5;
