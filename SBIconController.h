...
@class BBObserver, NSIndexPath, NSMutableArray, NSMutableSet, NSSet, NSString, NSTimer, SBApplicationShortcutMenu, SBFolder, SBIcon, SBIconColorSettings, SBIconModel, SBLeafIcon, SBRootFolderController, UITouch, _UILegibilitySettings;
...
@interface SBIconController : UIViewController <SBApplicationShortcutMenuDelegate, BBObserverDelegate, MCProfileConnectionObserver, SBApplicationRestrictionObserver, SBFolderControllerDelegate, SBSearchGestureObserver, SBIconViewDelegate, SBIconModelDelegate, SBIconViewMapDelegate, SBIconModelApplicationDataSource, SBReachabilityObserver>
{
    ...
    _Bool _skipCancelTouchesAfterShortcutMenuDismiss;
...
- (void)_dismissShortcutMenuAnimated:(_Bool)arg1 completionHandler:(CDUnknownBlockType)arg2;
- (void)dismissShortcutMenuWithCompletionHandler:(CDUnknownBlockType)arg1;
