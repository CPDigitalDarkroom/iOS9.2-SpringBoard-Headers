...
- (void)widgetViewControllerEndAppearanceTransitionIfNecessary:(id)arg1 completion:(CDUnknownBlockType)arg2;
- (void)widgetViewController:(id)arg1 beginAppearanceTransitionIfNecessary:(_Bool)arg2 animated:(_Bool)arg3;
- (void)widgetViewController:(id)arg1 beginAppearanceTransitionIfNecessary:(_Bool)arg2 animated:(_Bool)arg3 completion:(CDUnknownBlockType)arg4;
